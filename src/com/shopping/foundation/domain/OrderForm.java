...
public class OrderForm extends IdEntity {
    ...
    /*@ManyToMany
    @JoinTable(name = "shopping_goods_orderform", joinColumns = {
    ...
    //优惠券ids
    private String goods_coup_ids;
    //商品优惠额度
    private BigDecimal goods_coup_money;

    //积分抵现的钱
    private BigDecimal inte_money;
    //积分
    ...
    public BigDecimal getInte_money() {
        return inte_money;
    }

    public void setInte_money(BigDecimal inte_money) {
        this.inte_money = inte_money;
    }

    public String getGoods_coup_ids() {
        return goods_coup_ids;
    }

    public void setGoods_coup_ids(String goods_coup_ids) {
        this.goods_coup_ids = goods_coup_ids;
    }

    public BigDecimal getGoods_coup_money() {
        return goods_coup_money;
    }

    public void setGoods_coup_money(BigDecimal goods_coup_money) {
        this.goods_coup_money = goods_coup_money;
    }
