...
import com.shopping.core.query.QueryObject;
 ...
 public class OrderFormQueryObject extends QueryObject
 {
   ...
   public OrderFormQueryObject(){
     ...
     public OrderFormQueryObject(String currentPage,ModelAndView mv, String groupBy, String orderBy, String orderType){
         super(currentPage,mv, groupBy,orderBy,orderType);
     }
