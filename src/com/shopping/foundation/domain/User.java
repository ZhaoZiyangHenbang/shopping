...
private int integral_duihuan;

   public int getIntegral_duihuan() {
     return integral_duihuan;
   }

   public void setIntegral_duihuan(int integral_duihuan) {
     this.integral_duihuan = integral_duihuan;
   }

   //父邀请码
   private String parent_number;
   private String parent_p_number;
   private String parent_pp_number;

     public String getParent_p_number() {
         return parent_p_number;
     }

     public void setParent_p_number(String parent_p_number) {
         this.parent_p_number = parent_p_number;
     }

     public String getParent_pp_number() {
         return parent_pp_number;
     }

     public void setParent_pp_number(String parent_pp_number) {
         this.parent_pp_number = parent_pp_number;
     }
     //
   ...
   public void setStore_quick_menu(String store_quick_menu) {
     ...
     public String getQq_psw() {
         return qq_psw;
     }

     public void setQq_psw(String qq_psw) {
         this.qq_psw = qq_psw;
     }
