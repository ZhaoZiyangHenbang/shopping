...
public class Evaluate extends IdEntity {
	...
	@Column(columnDefinition = "LongText")
	private String evaluate_order_info;

	public String getEvaluate_order_info() {
		return evaluate_order_info;
	}

	public void setEvaluate_order_info(String evaluate_order_info) {
		this.evaluate_order_info = evaluate_order_info;
	}
