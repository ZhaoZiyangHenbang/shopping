...
import com.shopping.foundation.service.IUserService;
 ...
 public class QQLoginPlug
 {
   ...
   {
     String redirect_uri = "http://www.yijia1234.com/qq_login_bind.htm";
     String auth_url = "https://graph.qq.com/oauth2.0/authorize?response_type=code&client_id=" + this.configService.getSysConfig().getQq_login_id() + "&redirect_uri=" + redirect_uri + "&state=shopping&scope=get_user_info";
   ...
   {
     String redirect_uri = "http://www.yijia1234.com/qq_login_bind.htm";
     String token_url = "https://graph.qq.com/oauth2.0/token?grant_type=authorization_code&client_id=" + this.configService.getSysConfig().getQq_login_id() + "&client_secret=" + this.configService.getSysConfig().getQq_login_key() +
     ...
     /*if (SecurityUserHolder.getCurrentUser() == null) {*/
      // String userName = generic_username(CommUtil.null2String(user_map.get("nickname")));
       ...
       if (user == null) {
         ...
         return "redirect:/shopping_login.htm?username=" + CommUtil.encode(user.getUsername()) + "&password=123456";
       }
       request.getSession(false).removeAttribute("verify_code");
