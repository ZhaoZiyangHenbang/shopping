     ...
     if ((area_id != null) && (!area_id.equals(""))) {
       ...
       for (GoodsCart gc : sc.getGcs()) {
         ...
         if (goods.getGoods_transfee() == 0) {
           ...
           {
             mail_fee = mail_fee + cal_order_trans(goods.getTransport().getTrans_mail_info(), goods.getTransport().getTrans_type(), goods.getGoods_weight(), goods.getGoods_volume(), city_name);
 
             express_fee = express_fee + cal_order_trans(goods.getTransport().getTrans_express_info(), goods.getTransport().getTrans_type(), goods.getGoods_weight(), goods.getGoods_volume(), city_name);
 
             ems_fee = ems_fee + cal_order_trans(goods.getTransport().getTrans_ems_info(), goods.getTransport().getTrans_type(), goods.getGoods_weight(), goods.getGoods_volume(), city_name);
           }
           else
           {
