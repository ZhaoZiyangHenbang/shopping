 ...
 public class SubAccountSellerAction
 {
   ...
   public void sub_account_save(HttpServletRequest request, HttpServletResponse response, String id, String userName, String trueName, String sex, String birthday, String QQ, String telephone, String mobile, String password, String role_ids,String wx)
   {
     boolean ret = true;
     String msg = "保存成功";
