 ...
 public class GoodsBrandSellerAction extends IdEntity
 {
   ...
   {
     ModelAndView mv = new JModelAndView("user/second/seller_brandslist.html", this.configService.getSysConfig(), this.userConfigService.getUserConfig(), 0, request, response);
     ...
     qo.addQuery("obj.user.id", new SysMap("uid", SecurityUserHolder.getCurrentUser().getId()), "=");
       qo.addQuery("obj.PinOrSha", new SysMap("PinOrSha", CommUtil.null2String(2)), "=");
     ...
     CommUtil.saveIPageList2ModelAndView(url+"/seller/usergoodsbrand_list.htm", "", "", pList, mv);
     return mv;
   }
   ...
   {
     ModelAndView mv = new JModelAndView("user/second/seller_brandsapply.html", this.configService.getSysConfig(), this.userConfigService.getUserConfig(), 0, request, response);
     return mv;
   }
   ...
   public String usergoodsbrand_save(HttpServletRequest request, HttpServletResponse response, String id, String cmd, String cat_name, String list_url, String add_url) {
     ...
     if (id.equals("")) {
       ...
       goodsBrand.setUser(SecurityUserHolder.getCurrentUser());
         goodsBrand.setPinOrSha(CommUtil.null2String(2));
     } else {
