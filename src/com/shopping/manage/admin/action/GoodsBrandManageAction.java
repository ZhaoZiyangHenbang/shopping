 ...
 public class GoodsBrandManageAction
 {
   ...
   public ModelAndView list(HttpServletRequest request, HttpServletResponse response, String currentPage, String orderBy, String orderType, String name, String category)
   {
     ...
     qo.addQuery("obj.PinOrSha", new SysMap("PinOrSha", CommUtil.null2String(1)), "=");
...
/*     GoodsBrandCategory cat = this.goodsBrandCategoryService.getObjByProperty("name", cat_name);
     ...
     goodsBrand.setPinOrSha(CommUtil.null2String(1));
   ...
   public void goods_brand_verify(HttpServletRequest request, HttpServletResponse response, String name, String id) {
     ...
     List gcs = this.goodsBrandService
       .query(
       "select obj from GoodsBrand obj where obj.deleteStatus=:deleteStatus and obj.PinOrSha=:PinOrSha and obj.name=:name and obj.id!=:id", params, -1, -1);
