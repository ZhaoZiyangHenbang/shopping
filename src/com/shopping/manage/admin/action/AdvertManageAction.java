 ...
 public class AdvertManageAction
 {
   ...
   public ModelAndView advert_list(HttpServletRequest request, HttpServletResponse response, String currentPage, String orderBy, String orderType, String ad_title,String ad_posi_title)
   {
     ModelAndView mv = new JModelAndView("admin/blue/advert_list.html", this.configService.getSysConfig(), this.userConfigService.getUserConfig(), 0, request, response);
     ...
     if (null!=ad_title&&!CommUtil.null2String(ad_title).equals("")&&(null==ad_posi_title||CommUtil.null2String(ad_posi_title).equals(""))) {
       ...
       String param="&ad_title="+ad_title;
       CommUtil.saveIPageList2ModelAndView("/admin/advert_list.htm", "", param, pList, mv);
       return mv;
     }
     if (null!=ad_posi_title&&!CommUtil.null2String(ad_posi_title).equals("")&&(null==ad_title||CommUtil.null2String(ad_title).equals(""))) {
       qo.addQuery("obj.ad_ap.ap_title", new SysMap("ap_title", "%" + ad_posi_title.trim() + "%"), "like");
       mv.addObject("ad_posi_title", ad_posi_title);
       IPageList pList = this.advertService.list(qo);
       String param="&ad_posi_title="+ad_posi_title;
       CommUtil.saveIPageList2ModelAndView("/admin/advert_list.htm", "", param, pList, mv);
       return mv;
     }
     if (null!=ad_posi_title&&!CommUtil.null2String(ad_posi_title).equals("")&&null!=ad_title&&!CommUtil.null2String(ad_title).equals("")) {
       ...
       IPageList pList = this.advertService.list(qo);
       String param="&ad_posi_title="+ad_posi_title+"&ad_title="+ad_title;
       CommUtil.saveIPageList2ModelAndView("/admin/advert_list.htm", "", param, pList, mv);
       return mv;
     }
     IPageList pList = this.advertService.list(qo);
   ...
   {
     ModelAndView mv = new JModelAndView("admin/blue/advert_list_audit.html", this.configService.getSysConfig(), this.userConfigService.getUserConfig(), 0, request, response);
     AdvertQueryObject qo = new AdvertQueryObject(currentPage, mv, orderBy, orderType);
     if (!CommUtil.null2String(ad_title).equals("")) {qo.addQuery("obj.ad_title", new SysMap("ad_title", "%" + ad_title.trim() + "%"), "like");
     }
   ...
   {
     ModelAndView mv = new JModelAndView("/admin/blue/advert_add.html", this.configService.getSysConfig(), this.userConfigService.getUserConfig(), 0, request, response);
     List aps = this.advertPositionService.query("select obj from AdvertPosition obj where obj.ap_shangjia=1", null, -1, -1);
   ...
   @SecurityMapping(display = false, rsequence = 0, title="广告保存", value="/admin/advert_save.htm*", rtype="admin", rname="广告管理", rcode="advert_admin", rgroup="运营")
   @RequestMapping({"/admin/advert_save2.htm"})
   public ModelAndView advert_save2(HttpServletRequest request, HttpServletResponse response, String id, String ad_ap_id, String currentPage, String ad_begin_time, String ad_end_time)
   {
     WebForm wf = new WebForm();
     Advert advert = null;
     ...
     mv.addObject("url", CommUtil.getURL(request) + "/seller/store_adv.htm?currentPage=" + currentPage+"&user_id="+user_id);
     return mv;
   }
   ...
   public ModelAndView adv_pos_add(HttpServletRequest request, HttpServletResponse response, String id, String currentPage) {
     ModelAndView mv = new JModelAndView("admin/blue/adv_pos_add.html", this.configService.getSysConfig(), this.userConfigService.getUserConfig(), 0, request, response);
   ...
   public ModelAndView adv_pos_list(HttpServletRequest request, HttpServletResponse response, String currentPage, String orderBy, String orderType, String ap_title) {
     ModelAndView mv = new JModelAndView("admin/blue/adv_pos_list.html", this.configService.getSysConfig(), this.userConfigService.getUserConfig(), 0, request, response);
